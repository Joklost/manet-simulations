...
double reachi2::radiomodel::pep(double rssi, unsigned long packetsize, std::vector<double> interference) {
...
double reachi2::radiomodel::linearize(double logarithmic_value) {
    return std::pow(10, logarithmic_value / 10);
}

double reachi2::radiomodel::logarithmicize(double linear_value) {
