...
\begin{description}[style=nextline]
    ...
    \item[\mintinline{cpp}{template <typename T> void hardware::broadcast(T &packet)}]
    ...
    \item[\mintinline{cpp}{template <typename T> std::vector<T> hardware::listen(unsigned long time)}]
    ...
    \item[\mintinline{cpp}{void hardware::sleep(unsigned long time)}]
