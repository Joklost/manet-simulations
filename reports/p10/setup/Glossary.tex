...
{
    name={baud rate},
    description={The baud rate is the rate at which information can be transferred as a wireless signal~\cite{website:baudrate-mathworks}, and is equivalent to bits per second.}
}
