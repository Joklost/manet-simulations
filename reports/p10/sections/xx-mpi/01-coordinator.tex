...
%\filldraw[fill=white!20] (legend 04.north west) rectangle (legend 04.south east) node[midway,right=-0.4cm] {$a_{s,e}$ \ \ $a$: action, $s$: source, $e$: end};
...
\draw [dotted] 
    ...
    (t06 left) -- (t06 right) node[draw,fill=white,right,text width=5.6cm] {%
        time$_1$ $\leftarrow$ 6 \\ %
        waiting $\leftarrow$ \{ $t_4$,  $i_5$, $l_2$, $t_1$, $l_3$, \ldots \} \\ %
        transmissions $\leftarrow$ \{ $t_4$, $t_1$ \} %
    }%
    %
    ...
    (t10 left) -- (t10 right) node[draw,fill=white,right,text width=5.6cm] {%
        time$_2$ $\leftarrow$ 10 \\ %
        waiting $\leftarrow$ \{  \} \\ %
        transmissions $\leftarrow$ \{  \} %
    }%
    %
    ...
    (t14 left) -- (t14 right) node[draw,fill=white,right,text width=5.6cm] {%
    ...
    (t18 left) -- (t18 right) node[draw,fill=white,right,text width=5.6cm] {%
